...
* Hormonetherapy:  
  ...
  + Sequential sample T2 must be within a year but 82 days after radiation  
     + also needs to be before chemo/rad or no chemo/rad was given
...
blood_patients2 <- blood_patients %>% 
  ...
  mutate(seq_sample_hormone = case_when(
    presample_hormone_within_limits == "Yes" &
      blood_bf_hormone == "No" &
      specimen_collection_date > (hormone_therapy_start_date_1 + days(82)
                                  ) &
...
## 3-2.Time between chemotherapy stop date and T2
