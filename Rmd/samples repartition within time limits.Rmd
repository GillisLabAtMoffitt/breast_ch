...
#   distinct()
# 
# write_csv(a, "Samples list radiotherapy group in breast patients 03012022.csv")
```
<br>
<br>
...
#   distinct()
# 
# write_csv(a, "Samples list chemotherapy then radiotherapy group in breast patients 03012022.csv")
```
<br>
<br>
...
#   distinct()
# 
# write_csv(a, "Samples list hormonetherapy group in breast patients 03012022.csv")
```
